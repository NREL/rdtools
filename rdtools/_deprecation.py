...
# 1. use module-level _projectName = 'rdtools' and
#    _projectWarning = 'rdtoolsDeprecationWarning' in place of MPL specific
#    string/Class.
...
class rdtoolsDeprecationWarning(UserWarning):
    """A class for issuing deprecation warnings for rdtools users.
...
_projectName = 'rdtools'
_projectWarning = rdtoolsDeprecationWarning
