...
def test_energy_from_power_calculation():
    ...
    result = energy_from_power(power_series, pd.to_timedelta('15 minutes'))
...
def test_energy_from_power_max_interval():
    ...
    result = energy_from_power(power_series, pd.to_timedelta('5 minutes'))
...
def test_energy_from_power_validation():
    ...
    with pytest.raises(ValueError):
        energy_from_power(power_series, pd.to_timedelta('15 minutes'))
