...
from rdtools.bootstrap import construct_confidence_intervals,\
...
def test_bootstrap_module(cods_normalized_daily, cods_normalized_daily_wo_noise):
    ...
    bootstrap_samples = make_time_series_bootstrap_samples(cods_normalized_daily,
    ...
    confidence_intervals, exceedance_level, metrics = construct_confidence_intervals(
        bootstrap_samples, degradation_year_on_year, full_calc=False)
