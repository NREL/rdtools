...
* Many kwargs have changed name (but not input order) to bring nomenclature into 
   ...
   * :py:func:`~rdtools.aggregation.aggregation_insol` input kwarg has been renamed.
   * :py:func:`~rdtools.degradation.degradation_year_on_year` input kwarg has been renamed.
   * :py:func:`~rdtools.filtering.normalized_filter` input kwargs have been renamed.
   * :py:func:`~rdtools.filtering.poa_filter` input kwargs have been renamed.
   * :py:func:`~rdtools.filtering.tcell_filter` input kwargs have been renamed.
   * :py:func:`~rdtools.filtering.clip_filter` input kwargs have been renamed.
   * :py:func:`~rdtools.filtering.csi_filter` input kwargs have been renamed.
   * :py:func:`~rdtools.normalization.normalize_with_pvwatts` pvwatts_kws dictionary keys have been renamed.
   * :py:func:`~rdtools.normalization.normalize_with_expected_power` input kwargs have been renamed.
   * :py:func:`~rdtools.normalization.pvwatts_dc_power` input kwargs have been renamed.
   * :py:func:`~rdtools.normalization.irradiance_rescale` input kwargs have been renamed.
   * :py:func:`~rdtools.soiling.soiling_srr` input kwargs have been renamed.
